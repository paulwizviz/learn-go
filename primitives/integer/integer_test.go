...
func Example_uint8() {
	...
	fmt.Printf("Smallest value i8 %d\n", minusi8)
	fmt.Printf("Max value for i8 %d\n", maxi8)
	fmt.Printf("Max value for u8 %d\n", u8)

	fmt.Printf("Math package int8. Min: %d Max: %d\n", math.MinInt8, math.MaxInt8)
	fmt.Printf("Math package uint8. Max: %d", math.MaxUint8)
...
func Example_int16() {
	...
	fmt.Printf("Smallest value i16 %d\n", minusi16)
	fmt.Printf("Maximum value i16 %d\n", maxi16)
	fmt.Printf("Maximum value u16 %d\n", u16)
...
func Example_int32() {
	...
	fmt.Printf("Smallest value i32 %d\n", minusi32)
	fmt.Printf("Maximum value i32 %d\n", maxi32)
	fmt.Printf("Maximum value u32 %d\n", u32)
...
func Example_int64() {
	...
	fmt.Printf("Smallest value i64 %d\n", minusi64)
	fmt.Printf("Maximum value i64 %d\n", maxi64)
	fmt.Printf("Maximum value u64 %d\n", u64)

...
func main() {
    ...
    // This is the main routine and it executes immediately 
	// after the goroutine executes
	fmt.Println("World") // This operations blocks the main routine
	                     // but it does not block long enough for
						 // the goroutine's print operations to execute
    
}
```
[Working example](../examples/goroutine/ex1/main.go)
...
func main() {
	...
	time.Sleep(100 * time.Microsecond) // This cause the main routine to sleep for 100 microsec.
	                                   // The main routine sleeps long enought for goroutine to
									   // complete execution so you will see "Hello, 世界"
}
```
[Working example](../examples/goroutine/ex2/main.go)
...
```
[Working example](../examples//goroutine/ex3/main.go)
...
1 After increment: 0
 --- 
```
[Working example](../examples//goroutine/ex4/main.go)
...
```
[Working example](../examples/channel/ex1/main.go)
...
```
[Working example](../examples/channel/ex2/main.go)
...
```
[Working example](../examples/channel/ex3/main.go)
...
```
[Working example](../examples/channel/ex4/main.go)
...
```
[Working example](../examples/channel/ex5/main.go)
...
```
[Working example](../examples/channel/ex6/main.go)
...
```
[Working example](../examples/channel/ex7/main.go)
...
```
[Working example](../examples/channel/ex8/main.go)
